...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_3x6_5(
        ...
        KC_TRNS,    KC_A,                MT(MOD_LALT, KC_S),    MT(MOD_LCTL, KC_D),      MT(MOD_LSFT, KC_F),     KC_G,                              KC_H,       MT(MOD_LSFT, KC_J),      MT(MOD_LCTL, KC_K),    MT(MOD_LALT, KC_L),  MT(MOD_LGUI, KC_QUOTE),       KC_TRNS,
        KC_TRNS,    KC_Z,                KC_X,                  KC_C,                    KC_V,                   KC_B,                              KC_N,       KC_M,                    KC_COMM,               KC_DOT,              KC_SLASH,                     KC_TRNS,
                    KC_CAPS,             KC_TRNS,               LT(_NAV, KC_SPC),        LT(_MEDIA, KC_ENT),    KC_TRNS,                            KC_F19,     LT(_FUN, KC_TAB),        LT(_NUMBERS, KC_BSPC), KC_DEL,              KC_RGUI
    ),

    [_NAV] = LAYOUT_split_3x6_5(
        KC_TRNS,    KC_ESC,      LCTL(KC_X),    LCTL(KC_C), LCTL(KC_V),  LCTL(KC_Z),              KC_TRNS,    QK_DYNAMIC_MACRO_PLAY_1, QK_DYNAMIC_MACRO_RECORD_START_1, QK_DYNAMIC_MACRO_RECORD_STOP,     KC_TRNS,    KC_TRNS,
    ...
    [_FUN] = LAYOUT_split_3x6_5(
        KC_TRNS,    KC_TRNS,  KC_PGUP,  KC_UP,      KC_PGDN,  KC_TRNS,                  KC_PSCR,      KC_F1,    KC_F2,      KC_F3,    KC_F10,  KC_TRNS,
